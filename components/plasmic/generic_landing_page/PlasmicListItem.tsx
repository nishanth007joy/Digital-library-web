...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: F-wp_ecU3RysAD/css

import CheckCircleIcon from "./icons/PlasmicIcon__CheckCircle"; // plasmic-import: VYDGBvM8nGlNv0/icon
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg__qHqQ)}
            role={"img"}
          />
        ),
